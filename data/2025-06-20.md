...
### [1] [Coupled micro-resonators for second-order integrated nonlinear optics](https://arxiv.org/abs/2506.14959)
...
### [2] [Integrated microheater on the 4H-silicon-carbide-on-insulator platform and its applications](https://arxiv.org/abs/2506.15035)
...
### [3] [An effective microscopic model for plasmonic sensing of malaria](https://arxiv.org/abs/2506.15391)
...
### [4] [Efficient, inverse gigavoxel-scale optimization of diffractive lens](https://arxiv.org/abs/2506.15411)
...
### [5] [Simultaneous Charge Carrier Density Mapping of SiC Epilayers and Substrates with Terahertz Time-Domain Spectroscopy](https://arxiv.org/abs/2506.14945)
...
### [6] [Near-field optical mode engineering-enabled freeform nonlocal metasurfaces](https://arxiv.org/abs/2506.15495)
...
### [7] [All-Angle Scanning Leaky-Wave Antennas and Surface-Wave Routing by Reconfigurable Metasurfaces](https://arxiv.org/abs/2506.14954)
...
### [8] [Multi-timescale frequency-phase matching for high-yield nonlinear photonics](https://arxiv.org/abs/2506.15016)
...
TL;DR: The paper presents a novel nested frequency-phase matching framework for integrated nonlinear photonic systems, enabling high yield and broad bandwidths of multi-harmonic generation without requiring precise geometries or active tuning.


<details>
<summary>Details</summary>

Motivation: The motivation is to address the significant challenges in achieving wafer-scale yield of functional devices in integrated nonlinear photonic technologies, especially due to the stringent frequency and phase matching (FPM) conditions imposed by energy and momentum conservation laws.

Method: The researchers design a two-timescale lattice of commercially available silicon nitride (SiN) coupled ring resonators to implement nested frequency-phase matching, directly comparing it with conventional single-timescale systems.

Result: They observe distinct spatial and spectral signatures of nesting-enabled relaxation of FPM, demonstrating simultaneous fundamental, second, third, and fourth harmonic generation, achieving 100% multi-functional device yield across the wafer, and exhibiting ultra-broad harmonic bandwidths.

Conclusion: These advancements provide a scalable foundation for nonlinear optics, with potential applications in integrated frequency conversion, synchronization, self-referencing, metrology, squeezed light, and nonlinear optical computing.
...
### [9] [Geometric spin Hall effect of spatiotemporal optical vortices](https://arxiv.org/abs/2506.15053)
...
### [10] [Nano-resolved sensing of 3D electromagnetic fields via single emitters' extreme variation of enhanced spontaneous emission](https://arxiv.org/abs/2506.15095)
...
### [11] [Miniaturized Chaos-assisted Spectrometer](https://arxiv.org/abs/2506.15186)
...
### [30] [Catalytic $z$-rotations in constant $T$-depth](https://arxiv.org/abs/2506.15147)
*Isaac H. Kim*
...
### [31] [Entangling remote superconducting qubits via transducer-generated multi-time-bin states](https://arxiv.org/abs/2506.15277)
...
### [32] [Classical-quantum systems breaking conservation laws](https://arxiv.org/abs/2506.15291)
...
### [33] [Time-bin encoded quantum key distribution over 120 km with a telecom quantum dot source](https://arxiv.org/abs/2506.15520)
...
### [34] [Quantum Parameter Estimation Uncertainty Relation](https://arxiv.org/abs/2506.15352)
...
### [35] [Observation of Kardar-Parisi-Zhang universal scaling in two dimensions](https://arxiv.org/abs/2506.15521)
